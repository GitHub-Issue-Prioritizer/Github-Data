...
if __name__ == "__main__":
    ...
    'Priority-2','Priority-1','Priority-3','Priority-0',
    'p0-urgent','p1-important','p2-nice-to-have','p3-edge-case',
    'priority-0-high','priority-1-normal','priority-2-low'
    ]   
    repos = [
        ('microsoft','PowerToys',['Priority-2','Priority-1','Priority-3','Priority-0']),
         ('microsoft','terminal',['Priority-2','Priority-1','Priority-3','Priority-0']),
        ('sveltejs','kit',['p0-urgent','p1-important','p2-nice-to-have','p3-edge-case']),
    ...
    label_mapping = {
          1: [
            ...
            'Priority-0','Priority-1', #1,2
            'p0-urgent','p1-important', #3
             'priority-0-high' #4
        ],
        2: [
           'Priority-2' ,#1,2
